...
public class SplashScreenCursor : MonoBehaviour {
    ...
    private void Update()
    {
        cursorRight.rectTransform.position = Vector3.Lerp(cursorRight.rectTransform.position, GetGoalPositionRight(), Time.unscaledDeltaTime * lerpSpeed);
        cursorLeft.rectTransform.position = Vector3.Lerp(cursorLeft.rectTransform.position, GetGoalPositionLeft(), Time.unscaledDeltaTime * lerpSpeed);
    }
